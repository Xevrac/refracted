...
namespace GeneratedSerializers.CurrentVersion.Rts_CnC_Messages_Client_RequestGarrison
{
    public class Serializer
    {
        public static Type SerializedType{ get { return typeof(Rts.CnC.Messages.Client.RequestGarrison); } }
        
        public static void Serialize(System.IO.Stream s, object obj)
        {
            var value = (Rts.CnC.Messages.Client.RequestGarrison)obj;
        ...
        {
            var value = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Rts.CnC.Messages.Client.RequestGarrison)) as Rts.CnC.Messages.Client.RequestGarrison;
