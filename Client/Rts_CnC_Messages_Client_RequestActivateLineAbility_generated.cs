...
namespace GeneratedSerializers.CurrentVersion.Rts_CnC_Messages_Client_RequestActivateLineAbility
{
    public class Serializer
    {
        public static Type SerializedType{ get { return typeof(Rts.CnC.Messages.Client.RequestActivateLineAbility); } }
        
        public static void Serialize(System.IO.Stream s, object obj)
        {
            var value = (Rts.CnC.Messages.Client.RequestActivateLineAbility)obj;
            //  Serialize PlayerId
        ...
        {
            var value = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Rts.CnC.Messages.Client.RequestActivateLineAbility)) as Rts.CnC.Messages.Client.RequestActivateLineAbility;
