...
namespace GeneratedSerializers.CurrentVersion.Rts_CnC_Messages_Client_GameDefeat
{
    public class Serializer
    {
        public static Type SerializedType{ get { return typeof(Rts.CnC.Messages.Client.GameDefeat); } }
        
        public static void Serialize(System.IO.Stream s, object obj)
        {
            var value = (Rts.CnC.Messages.Client.GameDefeat)obj;
            //  Serialize TextId
        ...
        {
            var value = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Rts.CnC.Messages.Client.GameDefeat)) as Rts.CnC.Messages.Client.GameDefeat;
            //  Deserialize TextId
