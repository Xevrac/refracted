...
namespace GeneratedSerializers.CurrentVersion.Rts_CnC_Messages_Client_RequestAttackMoveGroup
{
    public class Serializer
    {
        public static Type SerializedType{ get { return typeof(Rts.CnC.Messages.Client.RequestAttackMoveGroup); } }
        
        public static void Serialize(System.IO.Stream s, object obj)
        {
            var value = (Rts.CnC.Messages.Client.RequestAttackMoveGroup)obj;
            //  Serialize PlayerId
        ...
        {
            var value = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Rts.CnC.Messages.Client.RequestAttackMoveGroup)) as Rts.CnC.Messages.Client.RequestAttackMoveGroup;
