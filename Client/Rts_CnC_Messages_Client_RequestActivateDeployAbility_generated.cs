...
namespace GeneratedSerializers.CurrentVersion.Rts_CnC_Messages_Client_RequestActivateDeployAbility
{
    public class Serializer
    {
        public static Type SerializedType{ get { return typeof(Rts.CnC.Messages.Client.RequestActivateDeployAbility); } }
        
        public static void Serialize(System.IO.Stream s, object obj)
        {
            var value = (Rts.CnC.Messages.Client.RequestActivateDeployAbility)obj;
            //  Serialize PlayerId
        ...
        {
            var value = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Rts.CnC.Messages.Client.RequestActivateDeployAbility)) as Rts.CnC.Messages.Client.RequestActivateDeployAbility;
