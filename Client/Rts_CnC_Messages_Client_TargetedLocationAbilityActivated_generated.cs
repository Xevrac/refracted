...
namespace GeneratedSerializers.CurrentVersion.Rts_CnC_Messages_Client_TargetedLocationAbilityActivated
{
    public class Serializer
    {
        public static Type SerializedType{ get { return typeof(Rts.CnC.Messages.Client.TargetedLocationAbilityActivated); } }
        
        public static void Serialize(System.IO.Stream s, object obj)
        {
            var value = (Rts.CnC.Messages.Client.TargetedLocationAbilityActivated)obj;
            //  Serialize Radius
        ...
        {
            var value = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Rts.CnC.Messages.Client.TargetedLocationAbilityActivated)) as Rts.CnC.Messages.Client.TargetedLocationAbilityActivated;
            //  Deserialize Radius
