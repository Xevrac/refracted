...
namespace GeneratedSerializers.CurrentVersion.Rts_CnC_Messages_Client_RequestMoveGroup
{
    public class Serializer
    {
        public static Type SerializedType{ get { return typeof(Rts.CnC.Messages.Client.RequestMoveGroup); } }
        
        public static void Serialize(System.IO.Stream s, object obj)
        {
            var value = (Rts.CnC.Messages.Client.RequestMoveGroup)obj;
            //  Serialize PlayerId
        ...
        {
            var value = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(Rts.CnC.Messages.Client.RequestMoveGroup)) as Rts.CnC.Messages.Client.RequestMoveGroup;
